...
Next task     : Collect/load SCOWL strict retry batch 006 when complete
```
...
- **2026-05-30 SCOWL strict retry batch 006:** Hardened `batch_submit_openai.ps1` to request OpenAI JSON-object responses, then retried the final 29 trusted missing words as core-mode priority 3 words with a stricter exact-headword addendum. Submitted OpenAI batch `batch_6a1b43c8d98481909dbbcdfb20b49f26`, pending collection.
